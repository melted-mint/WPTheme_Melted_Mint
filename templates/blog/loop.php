        ...
        <?php while ( have_posts() ): the_post(); ?>
            ...
            <li class="p-2 rounded-lg shadow-md grid grid-cols-1 sm:grid-cols-[1fr_auto] gap-4 cardComponent">
                ...
                <div class="pl-2 order-2 sm:order-1">
                    ...
                    <!-- 날짜 -->
                    <div class="mt-1 sm:mt-2 flex items-center text-xs sm:text-sm grayTextThings">
                        ...
                        <div>
                            ...
                            if ( $tags ) :
                                ...
                                foreach ( $tags as $index => $tag ) :
                                    ...
                                    class="btn btn-ghost rounded-lg px-1 h-7 hoveronlyButton">
                    ...
                    ?>
                    <div class="mt-1 sm:mt-2 text-xs sm:text-sm grayTextThings">
                        글자수(공백 제외): <?php echo number_format($char_count); ?>자,
                        읽는 시간: 약 <?php echo $reading_time; ?>분
                    </div>
                </div>

                <!-- 썸네일(대표이미지) -->
                <?php if ( has_post_thumbnail() ): ?>
                    <div class="-mb-2 sm:mb-0 h-30relative group overflow-hidden rounded order-1 sm:order-2"> <!-- 작은화면: order-1, 큰화면: order-2 -->
                        <div class="sm:w-60 w-full h-full">
