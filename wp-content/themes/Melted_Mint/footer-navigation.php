...
<div class="fixed bottom-4 w-full flex justify-center z-50">
    <!-- 실제 네비게이션 영역 -->
    <nav class="cardComponent shadow-lg rounded-xl inline-flex flex-nowrap items-center justify-center py-1 px-4 space-x-4">
        <!-- Home -->
        <a href="<?php echo home_url('/home'); ?>" class="btn btn-ghost availableButton p-3 rounded-xl text-xl">
        ...
        <!-- Blog -->
        <a href="<?php echo home_url('/blog'); ?>" class="btn btn-ghost availableButton p-3 rounded-xl text-xl">
        ...
        <!-- Community -->
        <a href="<?php echo home_url('/community'); ?>" class="btn btn-ghost availableButton p-3 rounded-xl text-xl">
            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor">
        ...
        <!-- About -->
        <a href="<?php echo home_url('/about'); ?>" class="btn btn-ghost availableButton p-3 rounded-xl text-xl">
            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor">
